...
const BooksAndStationery = () => {
  ...
  const [subCategory, setSubCategory] = useState(["Books", "Notebooks", "Pens & pencils", "Study materials"])

  useEffect(() => {
    const fruits = products.filter((item) => (item.category === 'Books & Stationery'))
    ...
    <div className='max-w-[1440px] mx-auto px-6 md:px-12 py-8 md:py-12'>
      <motion.div
        ...
        transition={{
          delay: 0.2,
          duration: 2
        }}> <Title title="Books & Stationery" /></motion.div>
