            ...
            <div className={`flex items-center justify-between py-2 transition-all duration-300 ${isScrolled ? '' : 'border-t border-gray-50 mt-1 pt-2'}`}>
              <div className='flex items-center gap-2 flex-1'>
                ...
                <nav className='hidden md:flex items-center gap-1 shrink-0'>
                  ...
                  <NavLink to='/currency' className={({ isActive }) => `px-4 py-2 rounded-xl text-xs font-black uppercase tracking-widest transition-all ${isActive ? 'bg-black text-white' : 'hover:bg-gray-100 text-gray-400 hover:text-black'}`}>Currency</NavLink>
